...
COMMON_VULTI_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_vulti_tools_have_kind(self):
        """Every common vulti tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_VULTI_TOOLS:
