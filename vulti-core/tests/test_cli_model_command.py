...
class TestModelCommand:
    ...
    def test_valid_model_from_api_saved_to_config(self, capsys):
        ...
        with patch("vulti_cli.models.fetch_api_models",
    ...
    def test_api_unreachable_accepts_and_persists(self, capsys):
        ...
        with patch("vulti_cli.models.fetch_api_models", return_value=None), \
             patch("cli.save_config_value") as save_mock:
    ...
    def test_validation_crash_falls_back_to_save(self, capsys):
        ...
        with patch("vulti_cli.models.validate_requested_model",
    ...
    def test_provider_colon_model_switches_provider(self, capsys):
        ...
        with patch("vulti_cli.runtime_provider.resolve_runtime_provider", return_value={
                 "provider": "zai",
                 "api_key": "zai-key",
                 "base_url": "https://api.z.ai/api/paas/v4",
             }), \
             patch("vulti_cli.models.fetch_api_models",
    ...
    def test_provider_switch_fails_on_bad_credentials(self, capsys):
        ...
        with patch("vulti_cli.runtime_provider.resolve_runtime_provider",
                   side_effect=Exception("No API key found")):
            cli_obj.process_command("/model nous:vulti-3")
