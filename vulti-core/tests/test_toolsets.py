...
class TestToolsetConsistency:
    ...
    def test_vulti_platforms_share_core_tools(self):
        """All vulti-* platform toolsets should have the same tools."""
        platforms = ["vulti-cli", "vulti-telegram", "vulti-discord", "vulti-whatsapp", "vulti-slack", "vulti-signal", "vulti-homeassistant"]
