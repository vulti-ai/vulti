...
class TestParserRegistry:
    ...
    def test_vulti_parser_registered(self):
        parsers = list_parsers()
        assert "vulti" in parsers
...
class TestVultiParser:
    @pytest.fixture
    def parser(self):
        return get_parser("vulti")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["vulti"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use vulti format since that's universal
