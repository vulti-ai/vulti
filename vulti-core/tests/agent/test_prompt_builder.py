...
class TestBuildContextFilesPrompt:
    ...
    def test_loads_soul_md_from_vulti_home_only(self, tmp_path, monkeypatch):
        monkeypatch.setenv("VULTI_HOME", str(tmp_path / "vulti_home"))
        vulti_home = tmp_path / "vulti_home"
        vulti_home.mkdir()
        (vulti_home / "SOUL.md").write_text("Be concise and friendly.", encoding="utf-8")
