"""Tests for the vulti_cli models module."""

from vulti_cli.models import OPENROUTER_MODELS, menu_labels, model_ids, detect_provider_for_model
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from vulti_cli.models import _find_openrouter_slug
