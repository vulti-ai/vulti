"""Tests for vulti_cli.tools_config platform tool persistence."""

from unittest.mock import patch

from vulti_cli.tools_config import (
    _get_platform_tools,
...
def test_save_platform_tools_preserves_mcp_server_names():
    ...
    Regression test for https://github.com/NousResearch/vulti-agent/issues/1247
    """
    config = {
        "platform_toolsets": {
    ...
    with patch("vulti_cli.tools_config.save_config"):
