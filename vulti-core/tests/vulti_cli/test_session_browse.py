"""Tests for the interactive session browser (`vulti sessions browse`).
...
from vulti_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """vulti sessions browse should be parseable."""
        from vulti_cli.main import main as _main_entry
