"""Slash command definitions and autocomplete for the Vulti CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rule", "Manage conditional automation rules", "Tools & Skills",
               cli_only=True, args_hint="[subcommand]",
               subcommands=("list", "create", "edit", "enable", "disable", "remove")),
...
def slack_subcommand_map() -> dict[str, str]:
    """Return subcommand -> /command mapping for Slack /vulti handler.

    Maps both canonical names and aliases so /vulti bg do stuff works
    the same as /vulti background do stuff.
    """
