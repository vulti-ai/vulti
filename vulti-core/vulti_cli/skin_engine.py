"""Vulti CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.vulti/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Vulti"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! 🛡"              # Shown on exit
      response_label: " 🛡 Vulti "       # Response box header label
...
.. code-block:: python
    ...
    from vulti_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Vulti"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.vulti/skins/
...
Drop a YAML file in ``~/.vulti/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces VULTI_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces VULTI_SHIELD)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Vulti — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Vulti",
            "welcome": "Welcome to Vulti! Type your message or /help for commands.",
            "goodbye": "Goodbye! 🛡",
            "response_label": " 🛡 Vulti ",
            "prompt_symbol": "❯ ",
...
def _skins_dir() -> Path:
    ...
    home = Path(os.getenv("VULTI_HOME", Path.home() / ".vulti"))
    return home / "skins"
