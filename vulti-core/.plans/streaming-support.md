# Streaming LLM Response Support for Vulti
...
```
VULTI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("VULTI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `vulti_cli/config.py` | 1 | +streaming config defaults |
