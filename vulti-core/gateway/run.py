            ...
            if _areg:
                ...
                _HUB_CHANNEL_PROMPTS = {
                    "onboard": (
                        ...
                        "5. Call update_own_profile(role='<role>') whenever you set or change your role.\n\n"
                    ...
                    "onboard-skills": (
                        ...
                        "CRITICAL: The default_skills widget must show TWO counts:\n"
                        "  - Available: total number of skills on disk (from skills_list)\n"
                        "  - Installed: number of skills actually installed for this agent\n"
                        "Update the widget after each install using modify_pane(action='update', widget_id='default_skills', ...). "
