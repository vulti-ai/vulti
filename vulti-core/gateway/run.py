            ...
            if _areg:
                ...
                _HUB_CHANNEL_PROMPTS = {
                    ...
                    "onboard-role": (
                        ...
                        "The MOMENT you can figure out the user's role from what they say, IMMEDIATELY write:\n"
                        f"  role.txt at {_soul_path.parent / 'role.txt'} — a SINGLE WORD "
                        "(one of: assistant, therapist, researcher, engineer, writer, analyst, coach, creative, ops). Just the word, nothing else.\n"
                        "  + Update the default_personality widget with your role.\n"
