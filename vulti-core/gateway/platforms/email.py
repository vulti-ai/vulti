"""
Email platform adapter for the Vulti gateway.

Allows users to interact with Vulti by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        msg_id = f"<vulti-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
