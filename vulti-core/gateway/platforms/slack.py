...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            @self._app.command("/vulti")
            async def handle_vulti_command(ack, command):
                await ack()
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from vulti_cli.commands import slack_subcommand_map
