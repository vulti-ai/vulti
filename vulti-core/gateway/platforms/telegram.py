...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("VULTI_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "Vulti stopped Telegram polling to avoid endless retry spam. "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if not acquired:
                ...
                message = (
                    "Another local Vulti gateway is already using this Telegram bot token"
            ...
            try:
                ...
                from vulti_cli.commands import telegram_bot_commands
