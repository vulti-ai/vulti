...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="ask", description="Ask Vulti a question")
        @discord.app_commands.describe(question="Your question for Vulti")
        ...
        @tree.command(name="reset", description="Reset your Vulti session")
        ...
        @tree.command(name="status", description="Show Vulti session status")
        ...
        @tree.command(name="stop", description="Stop the running Vulti")
        ...
        @tree.command(name="update", description="Update Vulti to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="thread", description="Create a new thread and start a Vulti session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Vulti in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Vulti session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Vulti: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Vulti"
        if len(content) > 80:
    ...
    def _thread_state_path() -> Path:
        ...
        return get_vulti_home() / "discord_threads.json"
