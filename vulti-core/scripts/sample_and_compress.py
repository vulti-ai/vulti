...
DEFAULT_DATASETS = [
    ...
    "NousResearch/vulti-agent-megascience-sft1",
    "NousResearch/Vulti-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Vulti-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-vulti-agent"
]
