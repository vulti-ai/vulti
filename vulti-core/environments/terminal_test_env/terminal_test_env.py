...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Vulti"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Vulti",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Vulti",
    },
    {
...
class TerminalTestEnv(VultiAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/vulti-agent/.env.
        """
