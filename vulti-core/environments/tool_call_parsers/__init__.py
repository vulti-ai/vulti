...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("vulti")
        class VultiToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "vulti", "mistral", "llama3_json")
...
from environments.tool_call_parsers.vulti_parser import VultiToolCallParser  # noqa: E402, F401
