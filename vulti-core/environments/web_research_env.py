...
Inspired by: GroceryMind — production Vulti doing live web research
             across German grocery stores (firecrawl + vulti-agent)
"""
...
# Ensure vulti-agent root is on path
...
class WebResearchEnvConfig(VultiAgentEnvConfig):
...
class WebResearchEnv(VultiAgentBaseEnv):
    """
