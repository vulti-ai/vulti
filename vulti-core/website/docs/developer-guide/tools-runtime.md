...
Vulti tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Vulti resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`vulti-cli`, `vulti-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `vulti-acp`
