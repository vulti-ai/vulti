...
description: "How Vulti saves trajectories, normalizes tool calls, and produces training-friendly outputs"
---

# Trajectories & Training Format

Vulti can save conversation trajectories for training, evaluation, and batch data generation workflows.
...
Vulti converts live conversation structure into a training-friendly format.
