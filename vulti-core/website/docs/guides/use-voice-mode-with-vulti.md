---
sidebar_position: 7
title: "Use Voice Mode with Vulti"
description: "A practical guide to setting up and using Vulti voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Vulti
...
- you want Vulti sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Vulti.
...
## Step 1: make sure normal Vulti works first
...
Vulti supports both local and cloud speech stacks.
...
4. Vulti transcribes and responds
...
- asking Vulti to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Vulti loop.

## Tuning CLI behavior

### Silence threshold

If Vulti starts/stops too aggressively, tune:
...
Vulti stays a normal chat bot, but can speak replies.
...
- you want Vulti to function like a portable research or ops assistant
...
Vulti joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Vulti detects speech boundaries
- transcripts are posted in the associated text channel
- Vulti responds in text and audio
...
1. get text Vulti working
2. install `vulti-agent[voice]`
