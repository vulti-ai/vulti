#!/usr/bin/env python3
"""
Mini-SWE-Agent Runner with Vulti Trajectory Format

This module provides a runner that uses mini-swe-agent's execution environments
(local, docker, modal) but outputs trajectories in the Vulti-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses mini-swe-agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Vulti format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Vulti-Agent format)
# ============================================================================
...
# ============================================================================
# Mini-SWE Runner with Vulti Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses mini-swe-agent environments but outputs
    trajectories in Vulti-Agent format.
    """
    ...
    def _convert_to_vulti_format(
        ...
        """
        Convert internal message format to Vulti trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Vulti trajectory format
        trajectory = self._convert_to_vulti_format(messages, task, completed)
...
def main(
    ...
    """
    Run mini-swe-agent tasks with Vulti trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Vulti Trajectory Format")
    print("=" * 60)
