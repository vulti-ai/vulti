...
Copies bundled skills from the repo's skills/ directory into ~/.vulti/skills/
...
The manifest lives at ~/.vulti/skills/.bundled_manifest.
"""
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.vulti/skills/ using the manifest.
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.vulti/skills/ ...")
