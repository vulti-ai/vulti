"""
Cron job management tools for Vulti.
...
def _origin_from_env() -> Optional[Dict[str, str]]:
    origin_platform = os.getenv("VULTI_SESSION_PLATFORM")
    origin_chat_id = os.getenv("VULTI_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        return {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("VULTI_SESSION_CHAT_NAME"),
...
Important safety rule: cron-run sessions should not recursively schedule more cron jobs.""",
    "parameters": {
        ...
        "properties": {
            ...
            "deliver": {
                "type": "string",
                "description": "Delivery target: origin, local, telegram, discord, signal, matrix, or platform:chat_id"
            },
            "model": {
                "type": "string",
