...
_VULTI_CORE_TOOLS = [
    ...
    # Wallet (gated on creditcard.json existing via check_fn)
    "wallet",
    # Vultisig vault management (gated on vultisig CLI installed via check_fn)
    "vault",
]
...
TOOLSETS = {
    ...
    "wallet": {
        "description": "Payment card and crypto vault management",
        "tools": ["wallet", "vault"],
        "includes": []
    },
    ...
    # ==========================================================================
    # Full Vulti toolsets (CLI + messaging platforms)
    #
    ...
    "vulti-email": {
        "description": "Email bot toolset - interact with Vulti via email (IMAP/SMTP)",
        "tools": _VULTI_CORE_TOOLS,
        "includes": []
    },
