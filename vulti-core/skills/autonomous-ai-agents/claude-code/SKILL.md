...
metadata:
  vulti:
    ...
    related_skills: [codex, vulti-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Vulti terminal. Claude Code is Anthropic's autonomous coding agent CLI.
