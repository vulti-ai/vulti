...
metadata:
  vulti:
    ...
    related_skills: [claude-code, vulti-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Vulti terminal. Codex is OpenAI's autonomous coding agent CLI.
