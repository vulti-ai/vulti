...
version: 1.1.0
author: Vulti (adapted from obra/superpowers)
license: MIT
metadata:
  vulti:
...
> **For Vulti:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Vulti tools to understand the project:
