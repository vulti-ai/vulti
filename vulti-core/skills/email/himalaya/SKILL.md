...
To reply non-interactively from Vulti, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Vulti)** — pipe the message via stdin:
