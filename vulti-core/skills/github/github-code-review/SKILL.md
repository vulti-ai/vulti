...
```bash
source ~/.vulti/skills/github/github-auth/scripts/gh-env.sh
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Vulti. Code looks clean — good test coverage, no security concerns."
