...
Built for [Vulti](https://github.com/NousResearch/vulti-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/vulti-agent/skills/creative/ascii-video`](https://github.com/NousResearch/vulti-agent/tree/main/skills/creative/ascii-video) via PR.
