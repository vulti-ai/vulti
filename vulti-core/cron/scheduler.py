...
def run_job(job: dict) -> tuple[bool, str, str, Optional[str]]:
    ...
    try:
        ...
        from vulti_cli.runtime_provider import resolve_runtime_provider, format_runtime_provider_error
        try:
            runtime_kwargs = {"requested": job.get("provider") or os.getenv("VULTI_INFERENCE_PROVIDER")}
            if job.get("base_url"):
        ...
        turn_route = resolve_turn_route(prompt, smart_routing, {
