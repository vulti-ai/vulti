// =========================================================================
// Vulti Landing Page — Interactions
// =========================================================================
...
const PLATFORMS = {
  linux: {
    command:
      "curl -fsSL https://raw.githubusercontent.com/jpthor/vulti-agent/main/scripts/install.sh | bash",
    prompt: "$",
...
const demoSequence = [
  ...
  {
    type: "type",
    text: "Review the PR at jpthor/vulti-agent#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
...
// --- Noise Overlay (ported from vulti-chat NoiseOverlay) ---
    ...
    if (!ticking) {
      requestAnimationFrame(() => {
        if (window.scrollY > 50) {
          nav.style.borderBottomColor = "rgba(26, 26, 26, 0.12)";
        } else {
