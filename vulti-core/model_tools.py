...
try:
    from vulti_cli.plugins import discover_plugins
    discover_plugins()
except Exception as e:
...
def get_tool_definitions(
    ...
    try:
        from vulti_cli.plugins import get_plugin_tool_names
...
def handle_function_call(
    ...
    try:
        ...
        try:
            from vulti_cli.plugins import invoke_hook
