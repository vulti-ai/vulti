"""ACP permission bridging — maps ACP approval requests to vulti approval callbacks."""
...
# Maps ACP PermissionOptionKind -> vulti approval result strings
_KIND_TO_HERMES = {
    "allow_once": "once",
    "allow_always": "always",
    "reject_once": "deny",
...
def make_approval_callback(
    ...
    """
    Return a vulti-compatible ``approval_callback(command, description) -> str``
