"""ACP session manager — maps ACP sessions to Vulti AIAgent instances."""
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed Vulti."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by Vulti AIAgent instances."""
    ...
    def __init__(self, agent_factory=None):
        ...
        Args:
            agent_factory: Optional callable that creates an AIAgent-like object.
                           ...
                           using the current Vulti runtime provider configuration.
        """
