...
<div class="space-y-8">
	...
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Send Messages & Email</h4>
		<ServiceConnector type="gmail" label="Gmail" category="communication" description="Send emails"
			status={getService('gmail') ? 'connected' : 'disconnected'}
			onConnect={() => connect('gmail', 'Gmail', 'communication')}
			onDisconnect={() => disconnect('gmail')} />
		<ServiceConnector type="icloud_mail" label="iCloud Mail" category="communication" description="Send emails"
		...
		<ServiceConnector type="whatsapp" label="WhatsApp" category="communication" description="Send messages"
		...
		<ServiceConnector type="telegram" label="Telegram" category="communication" description="Send messages"
		...
		<ServiceConnector type="imessage" label="iMessage" category="communication" description="Send messages"
		...
		<ServiceConnector type="slack" label="Slack" category="communication" description="Post to channels"
			status={getService('slack') ? 'connected' : 'disconnected'}
			onConnect={() => connect('slack', 'Slack', 'communication')}
			onDisconnect={() => disconnect('slack')} />
		<ServiceConnector type="discord" label="Discord" category="communication" description="Post to channels"
	...
	<!-- Files -->
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Write to Storage</h4>
		<ServiceConnector type="gdrive" label="Google Drive" category="files" description="Upload & write files"
			status={getService('gdrive') ? 'connected' : 'disconnected'}
			onConnect={() => connect('gdrive', 'Google Drive', 'files')}
			onDisconnect={() => disconnect('gdrive')} />
		<ServiceConnector type="icloud_drive" label="iCloud Drive" category="files" description="Write files"
		...
		<ServiceConnector type="dropbox" label="Dropbox" category="files" description="Upload files"
			status={getService('dropbox') ? 'connected' : 'disconnected'}
			onConnect={() => connect('dropbox', 'Dropbox', 'files')}
			onDisconnect={() => disconnect('dropbox')} />
		<ServiceConnector type="local_folders" label="Local Folders" category="files" description="Write to local filesystem"
	...
	<!-- Calendar & Contacts -->
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Manage Calendar & Contacts</h4>
		<ServiceConnector type="gcalendar" label="Google Calendar" category="calendar_contacts" description="Create & edit events"
		...
		<ServiceConnector type="icloud_calendar" label="iCloud Calendar" category="calendar_contacts" description="Create & edit events"
		...
		<ServiceConnector type="gcontacts" label="Google Contacts" category="calendar_contacts" description="Edit contacts"
		...
		<ServiceConnector type="icloud_contacts" label="iCloud Contacts" category="calendar_contacts" description="Edit contacts"
	...
	<!-- Knowledge -->
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Write to Knowledge</h4>
		<ServiceConnector type="apple_notes" label="Apple Notes" category="knowledge" description="Create & edit notes"
		...
		<ServiceConnector type="notion" label="Notion" category="knowledge" description="Create & edit pages"
			status={getService('notion') ? 'connected' : 'disconnected'}
			onConnect={() => connect('notion', 'Notion', 'knowledge')}
			onDisconnect={() => disconnect('notion')} />
		<ServiceConnector type="obsidian" label="Obsidian" category="knowledge" description="Write to vault"
	...
	<!-- Code -->
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Push Code</h4>
		<ServiceConnector type="github" label="GitHub" category="code" description="Create issues, PRs, push commits"
			status={getService('github') ? 'connected' : 'disconnected'}
			onConnect={() => connect('github', 'GitHub', 'code')}
			onDisconnect={() => disconnect('github')} />
		<ServiceConnector type="gitlab" label="GitLab" category="code" description="Create issues, MRs, push commits"
	...
	<!-- Other -->
	<section class="space-y-3">
		<h4 class="text-xs font-medium uppercase text-ink-muted">Control</h4>
		<ServiceConnector type="spotify" label="Spotify" category="other" description="Control playback"
			status={getService('spotify') ? 'connected' : 'disconnected'}
			onConnect={() => connect('spotify', 'Spotify', 'other')}
			onDisconnect={() => disconnect('spotify')} />
		<ServiceConnector type="homekit" label="HomeKit" category="other" description="Control devices"
			status={getService('homekit') ? 'connected' : 'disconnected'}
			onConnect={() => connect('homekit', 'HomeKit', 'other')}
			onDisconnect={() => disconnect('homekit')} />
		<ServiceConnector type="home_assistant" label="Home Assistant" category="other" description="Control devices"
